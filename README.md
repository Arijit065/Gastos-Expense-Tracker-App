...
1. **Clone the repository**
   ```bash
   git clone https://github.com/Arijit065/Gastos-Expense-Tracker-App.git
   cd Gastos-Expense-Tracker-App
   ```
...
- Send feedback to: arijitmandal065@gmail.com
...
- **Email** - Contact: arijitmandal065@gmail.com
